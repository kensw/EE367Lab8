...
{ 
int i;
// need to modify this FOR to create SOCKETS as well. 
// Using IF and ELSE? Need to figure out how to 
// modify FOR loop to do this. 
// Do we need a struc in link.h like uniPipeInfo?
